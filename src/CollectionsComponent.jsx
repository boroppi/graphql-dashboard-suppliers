...
const CollectionCreateForm = ({ visible, onCreate, onCancel }) => {
    ...
    const {data,loading, error} = useQuery(GET_ALL_ITEMS,  {variables: {"vendorId": "20170130806"}});
    ...
    rowData.mockData.forEach((object, index) => object.key = parseInt(object.itemId))
    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <Input
                        onInput={(e) => setCollection({...collection, title: e.target.value})}
                    />
                </Form.Item>
                <Form.Item name="description" label="Description">
                    <Input type="textarea" onInput={(e) => setCollection({...collection, description: e.target.value})}
                    />
                </Form.Item>
